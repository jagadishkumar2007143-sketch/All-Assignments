...
#Create a custom dataset using dictionary
data = {
    "Student": ["Aman", "Bhavya", "Charan", "Divya", "Esha", "Farhan", "Gita", "Hari"],
    "Math": [85, 78, 92, 88, 76, 95, 81, 89],
    "Science": [90, 82, 91, 85, 79, 94, 80, 87],
    "English": [88, 75, 89, 90, 81, 93, 84, 86]
}
